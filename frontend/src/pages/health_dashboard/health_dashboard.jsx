    ...
    <S.MainContainer>
      ...
      <S.ContentGrid>
        ...
        <S.ChartSection>
          ...
          <S.ChartPlaceholder>
            <S.ChartIcon className="fas fa-chart-area" />
            <S.ChartText>건강 점수 추이 차트 영역</S.ChartText>
            <S.ChartSubText>실제 구현 시 Chart.js 또는 Recharts 사용</S.ChartSubText>
          </S.ChartPlaceholder>
        </S.ChartSection>
        ...
        <S.StatisticsSection>
          ...
          <S.StatsGrid>
            <S.StatCard>
              <S.StatValue>{healthData.statistics.totalFlightHours}</S.StatValue>
              <S.StatLabel>{healthData.statistics.totalFlightHoursLabel}</S.StatLabel>
            </S.StatCard>
            <S.StatCard>
              <S.StatValue $color="#10b981">{healthData.statistics.recentFlights}</S.StatValue>
              <S.StatLabel>{healthData.statistics.recentFlightsLabel}</S.StatLabel>
            </S.StatCard>
            <S.StatCard>
              <S.StatValue $color="#f59e0b">{healthData.statistics.timezoneChanges}</S.StatValue>
              <S.StatLabel>{healthData.statistics.timezoneChangesLabel}</S.StatLabel>
            </S.StatCard>
            <S.StatCard>
              <S.StatValue $color="#8b5cf6">{healthData.statistics.upcomingFlights}</S.StatValue>
              <S.StatLabel>{healthData.statistics.upcomingFlightsLabel}</S.StatLabel>
            </S.StatCard>
          </S.StatsGrid>
